  ...
  const amountCards = [
    {
      ...
      value: <CurrencyDisplay amount={stats.totalConfirmedAmount} currency="USD" showSymbol={false} />,
      subtitle: 'Total aprobado',
      color: 'text-green-600',
    },
    {
      title: 'Monto Pendiente',
      value: <CurrencyDisplay amount={stats.totalPendingAmount} currency="USD" showSymbol={false} />,
    ...
    <div className={cn('space-y-6', className)}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {statCards.map((stat, index) => {
          ...
          return (
            <Card key={index} className={cn(stat.highlight && 'ring-2 ring-yellow-200 dark:ring-yellow-800')}>
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
