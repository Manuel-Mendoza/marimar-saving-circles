          ...
          <div className="flex flex-col space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                {cedula && (
                  <div>
                    <span className="text-sm font-medium text-gray-500 dark:text-gray-400">Cédula:</span>
                    <p className="text-sm text-gray-900 dark:text-white">{cedula}</p>
                  </div>
                )}
                {fechaRegistro && (
                  <div>
                    <span className="text-sm font-medium text-gray-500 dark:text-gray-400">Registro:</span>
